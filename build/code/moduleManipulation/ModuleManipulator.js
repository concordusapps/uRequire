var JSManipulator, ModuleManipulator, l, seekr, _,
...
JSManipulator = (function() {
  ...
  JSManipulator.prototype.evalByType = slang.certain({
    'string': function(val) {
...
ModuleManipulator = (function(_super) {
  ...
  function ModuleManipulator(js, options) {
    ...
    if ((_ref = (_base = this.options).extractFactory) == null) {
      _base.extractFactory = false;
    }
    this.moduleInfo = {};
